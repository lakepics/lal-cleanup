...
/**
 * Template Name: Summer 23 UC Groups
 */
?>
        ...
        <div class="container landing-container">
            <div class="row">
                <div class="col-md-5 mb-50 pt-51">
                    <img class="img-responsive" src="/wp-content/themes/LACC-sage-theme-master/assets/images/meetings-collage.jpg" alt="Lake Arrowhead Lodge offers amazing summer vibes, great accommodations, fun activities and award-winning dining">
                </div>
                <div class="col-md-5 col-md-offset-1 col-xs-10 col-xs-offset-1 pt-50 text-center">
                    ...
                    <h2>Meet at the Lake Arrowhead Lodge</h2>
                    <p>This summer, the UCLA Lake Arrowhead Lodge is open to UCLA and other University of California campus groups for conferences, meetings, retreats, team-building events, and any other kind of gathering for 10-200 participants.</p>
                    <p>Located in the breathtaking San Bernardino Mountains, our award-winning conference center and family resort is renowned for its beautiful 50-acre property, world-class food and hospitality, and fun activities. There is no better place to bring people together!</p>
                    <p>Call 909-337-2478 to learn more and to book your event, or submit a Request for Proposal below.</p>
                    <p class="text-center mb-50 pb-50 pt-25"><a class="btn lg" href="https://lakearrowheadlodge.com/request-a-proposal/">Request for Proposal</a></p>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid landing-container accommodation pt-50 pb-50">
        <div class="row mbg">
            <div class="col-md-4 col-md-offset-1 mt-50 mb-50 p-50" style="background: #FFFFFF">
                ...
                <p>Get away and relax for a few nights (or longer!) in one of our spacious chalets or go big and enjoy one of our thoughtfully updated vintage cabins. Free WiFi is available throughout the property, and most accommodations have their own deck and wood-burning fireplaces.</p>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-5 col-md-offset-1 col-xs-10 col-xs-offset-1 pt-50 text-center accommodation-copy">
                    <div>
                        ...
                        <p>Arts & Crafts (classes & drop-in, price varies)<br>
                            Kayaking ($20 per day, UC Affiliates only)<br>
                            Pontoon Cruise ($15, UC Affiliates only)
                        </p>
        ...
        <div class="container landing-container">
            <div class="row">
                <div class="col-md-9 pt-51">
                    <h2>Can't get enough of the Lodge?</h2>
                    <p>Coming for a UCLA or UC sponsored event and want to stay a little longer – or return with your family? Your chalet will be ready! Minimum two-night reservation required. </p>
                </div>
                <div class="col-md-6">
                    <p class="pb-50 pt-25"><a class="btn lg" href="/summer/ucla-affiliates">UCLA Affiliates</a></p>
                </div>
                <div class="col-md-6">
                    <p class="pb-50 pt-25"><a class="btn lg" href="/summer/uc-affiliates">Other UC Campus Affiliates</a></p>
                </div>
            </div>
        </div>
    </div>
