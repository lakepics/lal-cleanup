...
$rows = array(
    ...
    array_merge(
        ...
        array(
            ...
            'cards' => array(
                array( 'card_desktop_width' => '3', 'card_image' => $img['img_0'], 'card_badge' => 'Seasonal Story', 'card_label_treatment' => 'flag', 'card_style_preset' => 'carousel-card', 'card_images' => array( $img['img_0'], $img['img_4'] ), 'card_heading' => 'Atmospheric card', 'card_body' => '<p>Test tighter copy rhythm.</p>', 'card_button_label' => 'Open', 'card_button_url' => home_url( '/lake-arrowhead-accommodations/' ), 'card_button_style' => 'outline-dark' ),
    ...
    array_merge(
        ...
        array(
            ...
            'section_intro'    => '<p>All four cards use the prompt-card preset — dark gradient card, white outline CTA, UCLA blue flag. Tests the stripped-down card at 25% width.</p>',
            'card_badge_fill_color' => '#2774ae',
            'cards'            => array(
                array( 'card_desktop_width' => '3', 'card_badge' => 'Stay', 'card_label_treatment' => 'flag', 'card_style_preset' => 'prompt-card', 'card_heading' => 'Accommodations', 'card_body' => '<p>Browse room types and seasonal availability.</p>', 'card_button_label' => 'Explore', 'card_button_url' => home_url( '/lake-arrowhead-accommodations/' ), 'card_button_style' => 'outline-white' ),
                array( 'card_desktop_width' => '3', 'card_badge' => 'Plan', 'card_label_treatment' => 'flag', 'card_style_preset' => 'prompt-card', 'card_heading' => 'Conferences', 'card_body' => '<p>Full-service meeting spaces with AV support, catering, and on-site coordination — designed for groups of 10 to 250.</p>', 'card_button_label' => 'Explore', 'card_button_url' => home_url( '/conferences/' ), 'card_button_style' => 'outline-white' ),
                array( 'card_desktop_width' => '3', 'card_badge' => 'Dine', 'card_label_treatment' => 'flag', 'card_style_preset' => 'prompt-card', 'card_heading' => 'Culinary', 'card_body' => '<p>Seasonal menus in a lakeside setting.</p>', 'card_button_label' => 'Explore', 'card_button_url' => home_url( '/culinary-experience/' ), 'card_button_style' => 'outline-white' ),
                array( 'card_desktop_width' => '3', 'card_badge' => 'Explore', 'card_label_treatment' => 'flag', 'card_style_preset' => 'prompt-card', 'card_heading' => 'Recreation', 'card_body' => '<p>Trails, lake access, and outdoor programming throughout the year.</p>', 'card_button_label' => 'Explore', 'card_button_url' => home_url( '/lake-arrowhead-accommodations/' ), 'card_button_style' => 'outline-white' ),
            ),
        )
    ),
    array_merge(
    ...
    array(
        ...
        'content_background_color' => '#f6f3ed',
        'image_position' => 'left',
        'use_scrollwork' => 1,
        'scrollwork_color' => '#946E29',
        'padding_top' => '60px',
        'padding_bottom' => '60px',
    ),
    array(
        ...
        'linked_article' => $featured_post_id,
        'use_article_title' => 0,
        'use_article_excerpt' => 0,
        'use_article_featured_image' => 0,
        'section_image' => $img['img_4'],
        'section_eyebrow' => 'North Shore Tavern',
        'section_heading' => 'A place to gather, not just dine',
        'section_intro' => '<p>Whether you linger over dinner, settle in for a second round, or use it as a simple meeting point, the tavern gives the stay a reliable social center.</p>',
        'button_label' => 'Explore the Tavern',
        'button_url' => home_url( '/dining/' ),
    ...
    array(
        ...
        'section_intro' => '<p>This specimen uses the unified split-media component and a site image so you can review the actual production surface instead of a sandbox approximation.</p><p>It is the right lane for warmer editorial storytelling that needs more presence than a card grid.</p>',
        'section_image' => $img['img_4'],
    ...
    array(
        'acf_fc_layout' => 'section_split_media',
        'section_anchor_id' => 'reference-split-media-experience-list',
        'media_mode' => 'single_image',
        'split_media_variant' => 'experience_list',
        'content_source' => 'manual',
        'section_eyebrow' => 'Experiences',
        'section_heading' => 'More to experience, without overplanning',
        'section_intro' => '<p>The stay works best when there is enough to do, with room to keep the schedule light. That balance is part of the appeal.</p>',
        'experience_icon_style' => 'diamond',
        'experience_show_dividers' => 1,
        'experience_items' => array(
            array(
                'item_title' => 'Hiking & Trails',
                'item_body' => 'Walk out into the woods without overthinking the day. A little movement goes a long way here.',
            ),
            array(
                'item_title' => 'Lake Arrowhead Village',
                'item_body' => 'Browse nearby shops, pick up a few things, or build a lighter off-property afternoon into the trip.',
            ),
            array(
                'item_title' => 'Seasonal Activities',
                'item_body' => 'The pace shifts with the season, which is part of the appeal. The stay does not have to feel overprogrammed.',
            ),
            array(
                'item_title' => 'Group Gatherings',
                'item_body' => 'From casual meetups to milestone weekends, the setting does a lot of the hosting work for you.',
            ),
        ),
        'button_label' => '',
        'button_url' => '',
        ...
        'image_position' => 'right',
        'seam_enabled' => 1,
        'seam_gutter_width' => 'calc(var(--ssm-seam-width, 140px) + 20px)',
        'padding_top' => '60px',
        'padding_bottom' => '60px',
    ),
    array(
        'acf_fc_layout' => 'section_split_media',
        'section_anchor_id' => 'reference-split-media-about-band',
        'media_mode' => 'single_image',
        'split_media_variant' => 'about_band',
        'about_emphasize_single_lane' => 1,
        'about_background_preset' => 'blue_band',
        'content_source' => 'manual',
        'section_eyebrow' => 'About The Lodge',
        'section_heading' => 'Part of UCLA.<br>Designed for everyone.',
        'section_intro' => '<p>UCLA Lake Arrowhead Lodge has deep institutional roots, but the experience is broader than that. It is a place for alumni, families, couples, groups, and anyone looking for a mountain stay with more character than a typical hotel stop.</p>',
        'button_label' => '',
        'button_url' => '',
        'button_style' => 'outline-dark',
        'container_type' => 'container',
        ...
        'image_position' => 'left',
        'seam_enabled' => 0,
        'media_min_height' => 'clamp(260px, 18vw, 420px)',
        'padding_top' => '52px',
        'padding_bottom' => '52px',
    ),
    array(
