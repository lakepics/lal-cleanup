...
$rows = array(
    ...
    array(
        'acf_fc_layout' => 'section_image_collage',
        'section_anchor_id' => 'reference-collage',
        'section_eyebrow' => 'Image Collage',
        'section_heading' => 'Builder-backed collage specimen',
        'section_intro' => '<p>This collage now reads from ACF fields so we can tune overlap, offsets, and image rhythm in the admin UI.</p>',
        'content_alignment' => 'center',
        'container_type' => 'container',
        'background_color' => '#efede8',
        'padding_top' => '48px',
        'padding_bottom' => '48px',
        'collage_min_height' => '720px',
        'collage_gap' => '18px',
        'blend_mode' => 'multiply',
        'hover_scale' => '1.04',
        'enable_card_hover_effect' => 1,
        'collage_images' => array(
            array( 'image' => $img['img_0'], 'column_start' => 1, 'column_span' => 6, 'row_start' => 2, 'row_span' => 5, 'offset_x' => '0px', 'offset_y' => '0px', 'rotation' => '0deg', 'z_index' => 2 ),
            array( 'image' => $img['img_1'], 'column_start' => 5, 'column_span' => 6, 'row_start' => 1, 'row_span' => 3, 'offset_x' => '-36px', 'offset_y' => '18px', 'rotation' => '0deg', 'z_index' => 3 ),
            array( 'image' => $img['img_2'], 'column_start' => 7, 'column_span' => 5, 'row_start' => 5, 'row_span' => 3, 'offset_x' => '8px', 'offset_y' => '-18px', 'rotation' => '0deg', 'z_index' => 1 ),
        ),
    ),
    array(
