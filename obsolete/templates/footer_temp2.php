    <div class="container">
        <div class="row columns">
            <div class="col-md-2 bottom-logo">
                <!-- logo-->
                <img src="/wp-content/themes/LACC-sage-theme-master/dist/images/lacc_logo.svg" />
            </div>
            ...
            <div class="col-md-3 news">
                <!-- news & community -->
                     <h4 class="summer-jobs"><a href="http://lacc.ucla.edu/jobs">Summer Jobs</a></h4>
            ...
            <div class="col-md-3 social">
                ...
                <div class="footer-email">
                    ...
                    <?php gravity_form( 'Join Our Email List', $display_title = false, $display_description = false, $display_inactive = false, $field_values = null, $ajax = true, $tabindex, $echo = true ); ?>
                </div>
                ...
                <div class="social-buttons">
                    <div class="social-buttons-child">
                        ...
                        <a target="_blank" href="http://www.facebook.com/uclalakearrowhead"><i class="fa fa-facebook-f"></i></a>
                        <a target="_blank" href="http://www.yelp.com/biz/ucla-lake-arrowhead-conference-center-lake-arrowhead"><i class="fa fa-yelp"></i></a>
                        <a target="_blank" href="http://www.iaccmeetings.com/v/ucla-lake-arrowhead-conference-center"><img id="iacc" src="/wp-content/themes/LACC-sage-theme-master/dist/images/IACC_eps.svg" alt="LACC"></a>
                    </div>
                </div>
                    <div class="footer-summer-jobs"><h4 class="summer-jobs"><a href="http://lacc.ucla.edu/jobs">Summer Jobs</a></h4></div>
            </div>
        </div>
    </div>
    <div class="container-fluid hhs-footer hhs-group hidden-xs hidden-sm hidden-md">
        <div class="col-md-12 hhs-group">
            ...
            <span><a href="http://guesthouse.ucla.edu">UCLA Guest House</a></span>
