...
/**
 * Template Name: Summer - Friends & Family
 */
?>
        ...
        <div class="container landing-container">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1 col-xs-10 col-xs-offset-1 pt-50 text-center">
                    ...
                    <p class="text-center pb-50 pt-25"><a class="btn lg" href="https://bookings.travelclick.com/112652?RatePlanId=7616900#/guestsandrooms">Book Your Stay</a></p>
                </div>
            </div>
        </div>
    </div>
