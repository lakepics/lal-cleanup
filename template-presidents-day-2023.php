...
/**
 * Template Name: Presidents' Day Landing Page 
 */
?>
    ...
    <div class="container landing-container">
      <div class="row">
        <div class="col-md-6 mb-50 text-center">
          <h1 class="mb-30">Make Us Part of Your New Presidents' Day Tradition</h1>
          <h2 class="light mt-0">All-inclusive Weekend Package<br>
            Feb. 17-20, 2023<br>(3 nights)</h2>
          <h3>Arrival: <strong>Friday, Feb. 17, 2023 (4pm)</strong><br>
            Departure: <strong>Monday, Feb. 20, 2023 (after lunch)</strong></h3>
        ...
        <div class="col-md-5 col-md-offset-1 pt-50">
          ...
          <a class="btn rev" href="https://lakearrowheadlodge.com/assets/pdf/ucla-lake-arrowhead-lodge-presidents-2023-family-holiday-tentative-charts.pdf">See detailed activity schedule</a>
  ...
  <div class="left-scrollwork">
    <div class="container landing-container" id="book">
      <div class="row">
        ...
        <div class="col-md-12">
          <p class="text-center p-50"><a class="btn lg" href="https://bookings.travelclick.com/112652?groupID=3418171&hotelID=112652#/guestsandrooms">Book Your Stay</a></p>
        </div>
      </div>
    </div>
  </div>
