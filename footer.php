    ...
    <div class="container">
        <div class="row columns">
            <div class="col-md-12 bottom-logo">
                <!-- logo-->
                <img class="logo-footer" src="/wp-content/themes/LACC-sage-theme-master/assets/images/logo_v3_white.svg" />
            </div>
            ...
            <div class="col-md-3 social">
                ...
                <a target="_blank" href="https://www.instagram.com/uclalakearrowhead/"><i class="fa fa-instagram fa-lg"></i></a>
                <a target="_blank" href="http://www.twitter.com/uclaarrowhead"><i class="fa fa-twitter  fa-lg"></i></a>
                <a target="_blank" href="http://www.facebook.com/uclaarrowhead"><i class="fa fa-facebook-f fa-lg"></i></a>
                <a target="_blank" href="http://www.yelp.com/biz/ucla-lake-arrowhead-conference-center-lake-arrowhead fa-lg"><i class="fa fa-yelp"></i></a>
    ...
    <div class="container-fluid hhs-footer">
        ...
        <div class="row copy-tos">
           ...
           <div class="row">
            <div class="col-md-6">
                <div class="phone">
                <a href="tel://909 337 2478"><i  class="fa fa-phone" aria-hidden="true">CALL</i></a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="email">
                            <a href="mailto:UCLALakeArrowhead@ha.ucla.edu"><i class="fa fa-envelope-o" aria-hidden="true">MAIL</i></a>
                </div>
            </div>
        </div>
</footer>
