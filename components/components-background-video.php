...
<div class="video-hero-text-background-overlay">
    <button
        ...
        style="position:absolute;bottom:16px;right:16px;z-index:30;padding:12px 14px;background:rgba(0,0,0,0.65);color:#fff;border:0;border-radius:4px;cursor:pointer;font-size:16px;"
