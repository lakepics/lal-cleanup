<section id="text_img_button">
    <div class="container">
    <div class="row">
        <div class="col-md-7">
            <div class="">
                <h3 class="text_img_button__heading">Sports & Recreation
                                            <span class="col-one-heading-small"></span></h3>
                <div class="col-left-copy">
            ...
            <div class="col-md-5">
                <div class="">
                    <img class="img-responsive mobile-img" src="https://lakearrowheadconferencecenter.ucla.edu/wp-content/uploads/2017/05/lets_play_edit2.jpg">
                </div>
            </div>
        </div>
        </div>
