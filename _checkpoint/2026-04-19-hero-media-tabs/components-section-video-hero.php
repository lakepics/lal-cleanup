...
if ( ! in_array( $background_video_button_style, array( 'primary', 'secondary', 'brown', 'light', 'outline', 'outline-dark', 'outline-gold' ), true ) ) {
...
if ( have_rows( 'hero_cta_buttons' ) ) {
    while ( have_rows( 'hero_cta_buttons' ) ) {
        ...
        if ( $button_label && $button_url ) {
            if ( ! in_array( $button_style, array( 'primary', 'secondary', 'brown', 'light', 'outline', 'outline-dark', 'outline-gold' ), true ) ) {
...
.section-video-hero .hero-button--secondary {
    background: var(--lacc-color-accent, #9e7156) !important;
    background-color: var(--lacc-color-accent, #9e7156) !important;
    color: var(--lacc-color-white, #ffffff) !important;
    border: 1px solid var(--lacc-color-accent, #9e7156) !important;
}

.section-video-hero .hero-button--brown {
    background: #946E29 !important;
    background-color: #946E29 !important;
    color: var(--lacc-color-white, #ffffff) !important;
    border: 1px solid #946E29 !important;
}

.section-video-hero .hero-button--light {
    background: var(--lacc-color-cream, #f6f3ed) !important;
    background-color: var(--lacc-color-cream, #f6f3ed) !important;
    color: var(--lacc-color-ink, #51534a) !important;
    border: 1px solid var(--lacc-color-cream, #f6f3ed) !important;
}
...
.section-video-hero .hero-button--outline {
    ...
    color: var(--lacc-color-white, #ffffff) !important;
    border-color: var(--lacc-color-white, #ffffff) !important;
}
...
.section-video-hero .hero-button--outline-gold {
    background: transparent !important;
    background-color: transparent !important;
    color: var(--lacc-color-gold-bright, #f5b62b) !important;
...
.section-video-hero .hero-button--secondary:focus {
    background: #6f4e3c !important;
    background-color: #6f4e3c !important;
    border-color: var(--lacc-color-gold-bright, #f5b62b) !important;
    color: var(--lacc-color-white, #ffffff) !important;
}
...
.section-video-hero .hero-button--brown:focus {
    background: #6c4e16 !important;
    background-color: #6c4e16 !important;
    border-color: var(--lacc-color-gold-bright, #f5b62b) !important;
    color: var(--lacc-color-white, #ffffff) !important;
}
...
.section-video-hero .hero-button--outline-dark:focus {
    background: rgba(81,83,74,0.08) !important;
    background-color: rgba(81,83,74,0.08) !important;
}

.section-video-hero .hero-button--outline-gold:hover,
.section-video-hero .hero-button--outline-gold:focus {
    background: rgba(148,110,41,0.12) !important;
    background-color: rgba(148,110,41,0.12) !important;
    border-color: #946E29 !important;
