...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div class="container-fluid the-content-container pb-50 plr-0">
        <div class="container">
            <div class="row">
    ...
    <div class="container-fluid the-content-container plr-0 pt-50 pb-50">
        <div class="container">
            <div class="row mbg">
                <div class="col-md-12 text-center">
                    <h2>Other Things to Know</h2>
                </div>
                <div class="col-md-3 text-center mt-30"><a class="btn lg" href="/meetings/meeting-faqs/">Meeting FAQs</a></div>
                <div class="col-md-3 text-center mt-30"><a class="btn lg" href="/meetings/conference-planner-toolkit/">Planner Toolkit</a></div>
                <div class="col-md-3 text-center mt-30"><a class="btn lg" href="http://www.sustain.ucla.edu/housing/lacc/">Sustainability</a></div>
                <div class="col-md-3 text-center mt-30"><a class="btn lg" href="/about/directions/">Directions</a></div>
            </div>
        </div>
    </div>
    <!-- activities -->
    <div class="left-scrollwork pt-50 pb-50">
        <div class="container landing-container activities">
            <div class="row">
                ...
                <div class="col-md-<?php if($activities_md_col_value) { echo (10 - $activities_md_col_value); } ?> col-md-offset-1 mt-50">
