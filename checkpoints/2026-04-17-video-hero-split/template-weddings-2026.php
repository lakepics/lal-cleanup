...
<style>
  ...
  .wedding-container p,
  .wedding-container span.gform_description {
    margin: 1em auto;
    color: #777777;
  ...
  .weddings-2026-video-hero .background-video-vimeo {
    position: absolute;
    top: 0;
    left: 50%;
  ...
  .weddings-2026-video-hero .video-hero-text-container {
    position: relative;
    z-index: 3;
  }
